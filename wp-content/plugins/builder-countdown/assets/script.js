...
(function( $, d ){
	...
	function do_stopwatch(el) {
            var items = $( '.builder-countdown-holder',el );
            if(items.length>0){
                items.each(function(){
                        var thiz = $( this );
                        ...
                        thiz.countdown( {
                                ...
                                render : function( data ){
                                        thiz.find( '.years .date-counter' ).text( this.leadingZeros( data.years, 2 ) );
                                        thiz.find( '.days .date-counter' ).text( this.leadingZeros( data.days, 2 ) );
                                        thiz.find( '.hours .date-counter' ).text( this.leadingZeros( data.hours, 2 ) );
                                        thiz.find( '.minutes .date-counter' ).text( this.leadingZeros( data.min, 2 ) );
                                        thiz.find( '.seconds .date-counter' ).text( this.leadingZeros( data.sec, 2 ) );
                                },
                                onEnd : function(){
