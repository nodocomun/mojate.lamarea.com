(function ($) {
    var BuilderSlideshow = {
        ...
        bindScroll: function () {
            if (this.isDesktop()) {
                $('body').addClass('builder-slideshow-scroll');
        ...
        unbindScroll: function () {
            $('body').removeClass('builder-slideshow-scroll');
            $('.slider-pro').off("mousewheel");
        },
        showLoader: function () {
            if ($('.sp-slide').length > 0) {
                $('body').append('<div class="background-slideshow-loader-wrapper"><div></div></div>');
            }
        },
