...
class PTB_CMB_Slider extends PTB_Extra_Base {
    ...
    public function action_them_themplate($id, $type, $args, $data = array(), array $languages = array()) {
        ...
        <div class="ptb_back_active_module_row">
            ...
            <div class="ptb_back_active_module_input ptb_back_text">
                <input type="number" step="1" name="[<?php echo $id ?>][slideWidth]" id="ptb_<?php echo $id ?>[slideWidth]" value="<?php echo !empty($data['slideWidth'])? $data['slideWidth'] : '' ?>" min="0"/>
        ...
        <div class="ptb_back_active_module_row">
            ...
            <div class="ptb_back_active_module_input ptb_back_text">
                <input type="number" step="1" name="[<?php echo $id ?>][slideHeight]" id="ptb_<?php echo $id ?>[slideHeight]" value="<?php echo !empty($data['slideHeight'])? $data['slideHeight'] : '' ?>" min="0"/>
            ...
            <div value="1" class="ptb_back_active_module_input ptb_back_text">
                <div class="ptb_custom_select">
                    <select id="ptb_<?php echo $id ?>[autoHover]" name="[<?php echo $id ?>][autoHover]">
                        <option <?php if (!empty($data['autoHover'])): ?>selected="selected"<?php endif; ?> value="1"><?php _e('Yes', 'ptb_extra') ?></option>
            ...
            <div value="1" class="ptb_back_active_module_input ptb_back_text">
                <div class="ptb_custom_select">
                    <select id="ptb_<?php echo $id ?>[captions]" name="[<?php echo $id ?>][captions]">
                        ...
                        <option <?php if (!empty($data['captions'])): ?>selected="selected"<?php endif; ?> value="1"><?php _e('Yes', 'ptb_extra') ?></option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="ptb_back_active_module_input">
                <div class="ptb_custom_select">
                    <select id="ptb_<?php echo $id ?>[pager]" name="[<?php echo $id ?>][pager]">
                        <option <?php if (!empty($data['pager'])): ?>selected="selected"<?php endif; ?> value="1"><?php _e('Yes', 'ptb_extra') ?></option>
            ...
            <div class="ptb_back_active_module_input">
                <div class="ptb_custom_select">
                    <select id="ptb_<?php echo $id ?>[controls]" name="[<?php echo $id ?>][controls]">
                        <option <?php if (!empty($data['controls'])): ?>selected="selected"<?php endif; ?> value="1"><?php _e('Yes', 'ptb_extra') ?></option>
                ...
                <?php foreach ($values as $index => $v): ?>
                    ...
                    <li class="<?php echo $meta_key; ?>_option_wrapper ptb_cmb_option">
                        ...
                        <input type="text" name="<?php echo $link_name; ?>"
                               value="<?php echo $link; ?>" placeholder="<?php _e('Link', 'ptb_extra') ?>" class="ptb_extra_row_margin"/>
