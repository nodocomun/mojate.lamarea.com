	...
	<?php else: ?>
		...
		<?php if( $post_image = themify_get_image( 'ignore=true&w='.$themify->width.'&h='.$themify->height ) ) : ?>
			...
			<figure class="post-image <?php echo $themify->image_align; ?>">
				...
				<?php if( $themify->unlink_image != 'yes' ) : ?><a href="<?php echo themify_get_featured_image_link(); ?>"><?php endif; ?>
					<?php echo $post_image; ?><?php themify_zoom_icon(); ?>
				<?php if( $themify->unlink_image != 'yes' ) : ?></a><?php endif; ?>
