...
localStorage.setItem(this.key,a);this.isDocked=a},get:function(){return this.isDocked||"true"===localStorage.getItem(this.key)},setStyleRowToggle:function(){var a=ThemifyBuilderCommon.Lightbox,b=a.$lightbox.find(".tb-style-toggle"),a=a.$lightbox.find("#themify_builder_options_styling .themify_builder_field");b.addClass("tb-closed");a.addClass("tb-field-expanded")},setDoc:function(){this.checkIsVisual()&&this.get()&&(top_iframe.body.classList.add("tb_module_panel_docked"),this.setDefaultWidth(),this.setWidth(),
this.onResize(),b(k.top).off("tfsmartresize.docked").on("tfsmartresize.docked",function(){this.resize();this.onResize()}.bind(this)),b("body").off("themify_builder_change_mode.docked").on("themify_builder_change_mode.docked",function(a,b,d){this.setWidth();"desktop"!==d&&"desktop"===b&&setTimeout(function(){themifybuilderapp.toolbar.$el.width()!==top_iframe.documentElement.clientWidth&&(this.setWidth(),this.onResize())}.bind(this),500)}.bind(this)));this.setStyleRowToggle()},setDefaultWidth:function(){var a=
ThemifyBuilderCommon.Lightbox,b=a.getLightboxStorage(),d=this.defaultWidth;b&&b.dockedWidth&&(d=b.dockedWidth);a.$lightbox.css("width",d)},setWidth:function(){var a=(top_iframe.documentElement.clientWidth||top_iframe.body.clientWidth)-ThemifyBuilderCommon.Lightbox.$lightbox.css("height","").width();themifybuilderapp.toolbar.$el.css("width",a);this.workspace.css("width",a)},resize:function(a){this.checkIsVisual()&&this.get()&&(this.setWidth(),"stop"===a&&this.onResize())},onResize:function(){themifybuilderapp.Utils._onResize(!0)},
drag:function(a){this.checkIsVisual()&&((top_iframe.body.classList.toggle("themify-dock-highlight","drag"===a.type&&a.pageX+20>=k.top.innerWidth),a.pageX+20>=k.top.innerWidth&&"dragstop"===a.type)?(this.set(!0),this.setDoc()):this.get()&&(this.dockOut?this.dockOut&&"dragstop"===a.type?this.dockOut=0:50<this.dockOut-a.clientX&&(this.close(),this.dockOut=0,b(f).trigger("mouseup")):this.dockOut=a.clientX))},close:function(a,c){if(this.checkIsVisual()&&this.get()){var d=ThemifyBuilderCommon.Lightbox,
e=d.getLightboxStorage(),e={height:e.height?e.height:d.rsesizable.minHeight};a&&(e.top=k.top.innerHeight/2-d.$lightbox.innerHeight()/2,e.left=k.top.innerWidth/2-d.$lightbox.innerWidth()/2);d.$lightbox.width()<d.resizable.minWidth&&(e.width=d.resizable.minWidth);d.$lightbox.css(e);this.set(!1,c);top_iframe.body.classList.remove("tb_module_panel_docked");themifybuilderapp.toolbar.$el.css("width","");this.workspace.css("width","");this.onResize();b(k.top).off("tfsmartresize.docked");b("body").off("themify_builder_change_mode.docked")}}},
_cleanLightBoxContent:function(){this.forgetRow();this.$lightbox.find(".themify_builder_options_tab").empty();this.$lightbox.find(".themify_builder_lightbox_actions").children().not(".builder_cancel_lightbox, .builder_cancel_docked_mode").remove()},controlByKeyInput:function(){function a(a){83!==a.which||"INPUT"===f.activeElement.tagName||"TEXTAREA"===f.activeElement.tagName||!0!==a.ctrlKey&&!0!==a.metaKey||(a.preventDefault(),a.stopPropagation(),a=b(".builder_save_button",top_iframe),0<a.length?
a.trigger("click"):themifybuilderapp.toolbar.$el.find(".tb_toolbar_save").trigger("click"))}b(f).on("keydown",a);if("visual"===themifybuilderapp.mode)b(top_iframe).on("keydown",a)},clone:function(a){a=a.clone(!0);"visual"===themifybuilderapp.mode&&(a.find("video").trigger("pause"),a.find(".big-video-wrap").remove());return a},rememberRow:function(){this.rememberedRow=this.clone(b(".tb_element_cid_"+themifybuilderapp.activeModel.cid));this.rememberedCid=themifybuilderapp.activeModel.cid},revertToRememberedRow:function(){var a=
themifybuilderapp.Models.Registry.lookup(this.rememberedCid);if(a){var b=a.get("elType");"subrow"!==b&&"column"!==b&&a.trigger("custom:restorehtml",this.rememberedRow)}this.forgetRow()},forgetRow:function(){this.rememberedRow=this.rememberedCid=null},clickRadioOption:function(a,c){c=c?c:b(this);var d=c.hasClass("themify-builder-radio-dnd")?c.closest(".tb_repeatable_field_content"):ThemifyBuilderCommon.Lightbox.$lightbox,e=ThemifyBuilderCommon.getCheckedRadioInGroup(c,d),f=d.find('input[name="'+e.prop("name")+
'"]'),e=e.data("selected");f.each(function(){d.find(".tb-group-element-"+b(this).val()).hide()});b("."+e,d).show();d.find("[data-binding]:visible").each(function(){themifybuilderapp.Mixins.Common.doTheBinding(b(this),b(this).val())})},clickCheckboxOption:function(a,c){c=c?c:b(this);var d=c.hasClass("themify-builder-radio-dnd")?c.closest(".tb_repeatable_field_content"):ThemifyBuilderCommon.Lightbox.$lightbox;d.find(".tb-checkbox-element").hide();var e=c.parent(".themify-checkbox");(e.hasClass("tb-option-checkbox-revert")?
e.find("input:not(:checked)"):e.find("input:checked")).each(function(){d.find(".tb-checkbox-element."+b(this).data("selected")).show()})},bindStylingToggles:function(a){var c=b(this).prev("input");c.is(":checked")&&(a.stopPropagation(),a.preventDefault(),c.prop("checked",!1).trigger("change"))},bindStylingRows:function(a){a.preventDefault();a=b(this).nextUntil(".tb-style-toggle");this.classList.contains("tb-closed")?(this.classList.remove("tb-closed"),a.removeClass("tb-field-expanded")):(this.classList.add("tb-closed"),
a.addClass("tb-field-expanded"))},hideShowBorder:function(a,c){if(!a||!a.isTrigger){c||(c=b(this));var d=c.closest(".selectwrapper").siblings(".tb_border_wrapper");"none"===c.val()?d.hide():d.show()}},cancelKeyListener:function(a){var b=ThemifyBuilderCommon.Lightbox;27===a.keyCode&&(a.preventDefault(),b.cancel(a))},cancel:function(a){a.preventDefault();a=ThemifyBuilderCommon.Lightbox;null!==a.rememberedCid&&a.revertToRememberedRow();a.close()},resetStyling:function(a){a.preventDefault();var c=b("#themify_builder_options_styling",
top_iframe),d=[];c.find(".tb_lb_option:not(.exclude-from-reset-field)").each(function(){if("radio"===b(this).prop("type")){var a=b(this).prop("name");-1===d.indexOf(a)&&c.find('[name="'+a+'"]:first').prop("checked",!0).trigger("change")}else b(this).hasClass("themify-builder-uploader-input")?b(this).val("").trigger("change").parent().find(".img-placeholder").empty():b(this).hasClass("font-family-select")?b(this).val("default").trigger("change"):b(this).hasClass("minicolors-input")?(a=b(this).val(""),
"visual"===themifybuilderapp.mode?b("body").trigger("themify_builder_color_picker_change",[a.attr("id"),a,""]):a.trigger("change").parent().next(".color_opacity").val("")):b(this).hasClass("tb_unit")?b(this).val("px").trigger("change"):b(this).val("").prop("selected",!1).trigger("change")})},switchTabs:function(a){var c=ThemifyBuilderCommon.Lightbox;a.preventDefault();a.stopPropagation();a=b(this).find("a").attr("href");c=c.$lightbox.find(a);c[0]!==m&&(b(this).addClass("current").siblings().removeClass("current"),
c[0].SimpleBar===m&&0<b(this).closest(".themify_builder_options_tab").length&&new SimpleBar(c[0]),c.show().siblings(".themify_builder_options_tab_wrapper,.themify_builder_tab").hide(),b("body").trigger("themify_builder_tabsactive",[a,c]),"visual"===themifybuilderapp.mode&&b(f).trigger("mouseup"))}},LiteLightbox:{modal:new wp.media.view.Modal({controller:{trigger:function(){}}}),confirmView:Backbone.View.extend({template:wp.template("builder_lite_lightbox_confirm"),className:"themify_builder_lite_lightbox_content",
initialize:function(a){this.options=a||{}},render:function(){this.$el.html(this.template({message:this.options.message,buttons:this.options.buttons}))},events:{"click button":"buttonClick"},buttonClick:function(a){a.preventDefault();a=b(a.currentTarget).data("type");this.trigger("litelightbox:confirm",a)}}),promptView:Backbone.View.extend({template:wp.template("builder_lite_lightbox_prompt"),className:"themify_builder_lite_lightbox_content",initialize:function(a){this.options=a||{}},render:function(){this.$el.html(this.template(this.options))},
events:{"click button":"buttonClick","keypress .themify_builder_litelightbox_prompt_input":"keyPress"},buttonClick:function(a){a.preventDefault();a=b(a.currentTarget).data("type");var c=this.$el.find(".themify_builder_litelightbox_prompt_input").val();this.trigger("litelightbox:prompt",a,c)},keyPress:function(a){13===a.which&&(a=b(a.currentTarget).val(),this.trigger("litelightbox:prompt","ok",a))}}),confirm:function(a,c,d){d=_.defaults(d||{},{buttons:{no:{label:"No"},yes:{label:"Yes"}}});d.message=
...
a.on("litelightbox:prompt",function(a,d){ThemifyBuilderCommon.LiteLightbox.modal.close();b.isFunction(c)&&c.call(this,"cancel"===a?null:d)})},alert:function(a){ThemifyBuilderCommon.LiteLightbox.confirm(a,null,{buttons:{yes:{label:"OK"}}})}},templateCache:{templates:[],get:function(a){this.templates[a]===m&&(this.templates[a]=f.getElementById(a).innerHTML);return this.templates[a]}}}})(jQuery,window,document);
