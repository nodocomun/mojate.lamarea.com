...
if(c){var d=c.get("elType"),f=ThemifyBuilderCommon.Clipboard.get(d);if(!1===f)ThemifyBuilderCommon.alertWrongPaste();else if(ThemifyBuilderCommon.confirmDataPaste()){b.eventName="row";if("column"===d||"sub-column"===d)f.grid_class=b.Utils.filterClass(a.prop("class")),a.hasClass("first")?f.grid_class+=" first":a.hasClass("last")&&(f.grid_class+=" last"),d=a[0].style.width,f.grid_width=d?d.replace("%",""):null;b.beforeEvent=ThemifyBuilderCommon.clone(a);b.hasChanged=!0;c.setData(f)}}},"import":function(a){a.preventDefault();
...
attributes:function(){var a="custom_css_row"in this.model.attributes.styling&&-1!==this.model.attributes.styling.custom_css_row.indexOf("tb-page-break")?"tb-page-break":"";return{"class":"themify_builder_row module_row clearfix tb_element_cid_"+this.model.cid+" "+a,"data-cid":this.model.cid}},events:{"click .tb_option_row":"edit",dblclick:"edit","click .tb_style_row":"edit","click .tb_visibility_component ":"edit","click .tb_grid_list li a":"_gridClicked","click .grid_tabs li a":"_switchGridTabs",
...
g).data("opacity",g).val(g);f&&0>=parseFloat(e(this).minicolors("opacity"))&&e(this).minicolors("opacity",0);var h=f?e(this).minicolors("rgbaString"):"";void 0!==a.binding_type?a.preview_element(h):"visual"===b.mode&&Themify.body.trigger("themify_builder_color_picker_change",[d,a.$el,f?h:""])}}).minicolors("show");a.el.parentNode.insertAdjacentHTML("beforeend",'<div class="tb_clear_btn"></div>');b.Utils.createClearBtn(a.$el);c.on("blur keyup",function(b){var c=parseFloat(e.trim(e(this).val()));if(1<
c||isNaN(c)||""===c||0>c)c=a.$el.val()?1:"","blur"===b.type&&e(this).val(c);e(this).attr("data-opacity",c);a.is_typing="keyup"===b.type;a.$el.minicolors("opacity",c)})}});b.Views.register_control("repeater",{events:{"click .toggle_row":"toggleField","click .tb_duplicate_row":"duplicateRowField","click .tb_delete_row":"deleteRowField"},initialize:function(){this.render()},render:function(){var a=this.$el,b=this,d=!1;a.sortable({items:".tb_repeatable_field",handle:".tb_repeatable_field_top",axis:"y",
...
k()):k()};F.class_widget=f;h.addClass("tb_loading_widgets_form").html('<i class="fa fa-refresh fa-spin"></i>');e.ajax({type:"POST",dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"module_widget_get_form",tb_load_nonce:themifyBuilder.tb_load_nonce,load_class:f,tpl_loaded:1===d.cache[g]?1:0,id_base:g,widget_instance:c},success:function(a){a&&a.form&&(k(a),d.cache[g]=1)}})},render:function(){var a=this,c=b.activeModel.get("mod_settings"),d=a.$el.closest(".tb_input").find("#widgets-search"),f=
d.prev(".tb_loading_widgets"),g=function(){function g(b,c){b.addClass("selected").siblings().removeClass("selected");a.select(b,c);a.$el.removeAttr("data-validation");d.val(b.find(".widget-title").text());a.hide();a.$el.find(".widget-tpl").show()}var h=c[a.$el.prop("id")];a.el.insertAdjacentHTML("afterbegin",a.data);h?(h=a.$el.find('[data-value="'+h+'"]'),g(h,c.instance_widget)):new SimpleBar(a.el);a.$el.find(".widget-tpl").click(function(){g(e(this),null)});a.search();f.remove();f=null;b.hasChanged=
!0};f.show();if(null===this.data){for(var h in themifyBuilder.widget_css)window.top.Themify.LoadCss(themifyBuilder.widget_css[h]);themifyBuilder.widget_css=null;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_widget_items",nonce:themifyBuilder.tb_load_nonce},success:function(b){a.data=b;g()}})}else setTimeout(g,1);return this}});b.Views.register_control("widget_form",{initialize:function(){this.render()},render:function(){var a=this;this.$el.on("change",":input",function(){a.preview_element(a.$el.find(":input").themifySerializeObject())});
return this}});b.Views.register_control("layout_part",{data:[],get:function(a){var b=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(c){ThemifyBuilderCommon.showLoader("hide");b.data=c;a()},error:function(){ThemifyBuilderCommon.showLoader("error")}})},initialize:function(){this.render()},render:function(){function a(){for(var a=
"<option></<option>",e=b.activeModel.get("mod_settings")[c.$el.prop("id")],g=0,h=c.data.length;g<h;++g)a+="<option"+(e===c.data[g].post_name?' selected="selected"':"")+' value="'+c.data[g].post_name+'">'+c.data[g].post_title+"</option>";c.el.insertAdjacentHTML("afterbegin",a);c.$el.change(function(){c.preview_element(this.value)})}var c=this;0===this.data.length?this.get(a):a();return this}})})(jQuery);
