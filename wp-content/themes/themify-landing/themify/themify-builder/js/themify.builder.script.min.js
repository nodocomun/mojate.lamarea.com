...
(b.fn.themifyBuilderImagesLoaded=function(b){var g=this.filter("img"),k=g.length;g.bind("load.imgloaded",function(){0>=--k&&"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==this.src&&(g.unbind("load.imgloaded"),b.call(g,this))}).each(function(){if(this.complete||void 0===this.complete){var a=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=a}});return this})})(jQuery);
